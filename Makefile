...
publish: ## Publishes a new version to pypi
	rm -f dist/* && python setup.py sdist bdist_wheel && twine upload dist/* && echo 'Success! Go to https://pypi.python.org/pypi/draftjs_exporter_markdown and check that all is well.'
